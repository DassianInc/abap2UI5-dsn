CLASS /dsn/2ui5_cl_http_handler DEFINITION
  PUBLIC
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    CLASS-METHODS run
      IMPORTING
        ...
        config TYPE /dsn/2ui5_if_types=>ty_s_http_config OPTIONAL
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO /dsn/2ui5_cl_http_handler.
    ...
    CLASS-METHODS _http_post
      IMPORTING
        is_req        TYPE /dsn/2ui5_cl_util_http=>ty_s_http_req
      RETURNING
        VALUE(result) TYPE /dsn/2ui5_if_core_types=>ty_s_http_res.

    CLASS-METHODS _http_get
      IMPORTING
        is_config     TYPE  /dsn/2ui5_if_types=>ty_s_http_config
      RETURNING
        VALUE(result) TYPE string.

    METHODS main
      IMPORTING
        s_config TYPE /dsn/2ui5_if_types=>ty_s_http_config OPTIONAL.
    ...
    CLASS-METHODS get_request
      IMPORTING
        ...
        res           TYPE REF TO object OPTIONAL
          PREFERRED PARAMETER server
      RETURNING
        VALUE(result) TYPE /dsn/2ui5_cl_util_http=>ty_s_http_req.
    ...
    CLASS-METHODS get_response
      IMPORTING
        ...
        req    TYPE REF TO object OPTIONAL
        res    TYPE REF TO object OPTIONAL
        is_res TYPE /dsn/2ui5_if_core_types=>ty_s_http_res.

  PROTECTED SECTION.
    CLASS-DATA so_sticky_handler TYPE REF TO /dsn/2ui5_cl_core_handler.

    DATA mo_server TYPE REF TO /dsn/2ui5_cl_util_http.

    DATA ms_req    TYPE /dsn/2ui5_cl_util_http=>ty_s_http_req.
    DATA ms_res    TYPE /dsn/2ui5_if_core_types=>ty_s_http_res.
    DATA ms_config TYPE /dsn/2ui5_if_types=>ty_s_http_config.
...
CLASS /dsn/2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = /dsn/2ui5_cl_util_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = /dsn/2ui5_cl_util_http=>factory_cloud( req     = req
                                                               res = res ).
  ...
  METHOD _http_get.
    ...
    /dsn/2ui5_cl_exit=>get_instance( )->set_config_http_get( CHANGING cs_config = ls_config ).

    IF ls_config-styles_css IS INITIAL.
      DATA(lv_style_css) = /dsn/2ui5_cl_app_style_css=>get( ).
    ELSE.
    ...
    result = |<!DOCTYPE html>| && |\n| &&
             ...
             |      "z2ui5/manifest.json": '{ /dsn/2ui5_cl_app_manifest_json=>get( ) }',| && |\n| &&
             |      "z2ui5/Component.js": function()\{{ /dsn/2ui5_cl_app_component_js=>get( ) }{ ls_config-custom_js }\},| && |\n| &&
             |      "z2ui5/model/models.js": function()\{{ /dsn/2ui5_cl_app_models_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/view/App.view.xml": '{ /dsn/2ui5_cl_app_app_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/controller/App.controller.js": function()\{{ /dsn/2ui5_cl_app_app_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/view/View1.view.xml": '{ /dsn/2ui5_cl_app_view1_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/controller/View1.controller.js": function()\{{ /dsn/2ui5_cl_app_view1_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/Server.js": function()\{{ /dsn/2ui5_cl_app_server_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/DebugTool.fragment.xml": '{ /dsn/2ui5_cl_app_debugtool_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/cc/DebugTool.js": function()\{{ /dsn/2ui5_cl_app_debugtool_js=>get( ) }\},| && |\n| &&
             |    \});| && |\n| &&
  ...
  METHOD _http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW /dsn/2ui5_cl_core_handler( is_req-body ).
    ELSE.
    ...
    TRY.
        IF lo_post IS BOUND.
          DATA(li_app) = CAST /dsn/2ui5_if_app( lo_post->mo_action->mo_app->mo_app ).
  ...
  METHOD _main.
    ...
    /dsn/2ui5_cl_exit=>init_context( is_req ).

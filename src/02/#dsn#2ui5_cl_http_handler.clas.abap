CLASS /dsn/2ui5_cl_http_handler DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS _http_post
      IMPORTING
        is_req        TYPE /dsn/2ui5_if_core_types=>ty_s_http_req
      RETURNING
        VALUE(result) TYPE /dsn/2ui5_if_core_types=>ty_s_http_res.

    CLASS-METHODS _http_get
      IMPORTING
        VALUE(is_config) TYPE  /dsn/2ui5_if_types=>ty_s_http_config
      RETURNING
    ...
    CLASS-METHODS get_request
      IMPORTING
        ...
        res           TYPE REF TO object OPTIONAL
          PREFERRED PARAMETER server
      RETURNING
        VALUE(result) TYPE /dsn/2ui5_if_core_types=>ty_s_http_req.
  ...
  PROTECTED SECTION.
    ...
    DATA mo_server TYPE REF TO /dsn/2ui5_cl_abap_api_http.

    DATA ms_req    TYPE /dsn/2ui5_if_core_types=>ty_s_http_req.
...
CLASS /dsn/2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = /dsn/2ui5_cl_abap_api_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = /dsn/2ui5_cl_abap_api_http=>factory_cloud( req = req
                                                               res = res ).
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
    ...
    result = |<!DOCTYPE html>| && |\n| &&
             ...
             |      "z2ui5/Component.js": function()\{{ /dsn/2ui5_cl_app_component_js=>get( ) }{ is_config-custom_js }\},| && |\n| &&

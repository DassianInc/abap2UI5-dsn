CLASS /dsn/2ui5_cl_pop_bal DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO /dsn/2ui5_cl_pop_bal.
...
CLASS /dsn/2ui5_cl_pop_bal IMPLEMENTATION.
  METHOD factory.
    ...
    "read messages..
    DATA(lt_msg) = /dsn/2ui5_cl_util=>msg_get_t( i_messages ).
    LOOP AT lt_msg REFERENCE INTO DATA(lr_row).

      DATA(ls_row) = VALUE ty_s_msg( ).
      ls_row-type       = /dsn/2ui5_cl_util=>ui5_get_msg_type( lr_row->type ).
      ...
      ls_row-date       = /dsn/2ui5_cl_util=>time_get_date_by_stampl( lr_row->timestampl ).
      ls_row-time       = /dsn/2ui5_cl_util=>time_get_time_by_stampl( lr_row->timestampl ).
*      lr_row->group = `001`.

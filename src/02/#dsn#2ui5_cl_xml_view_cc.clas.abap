CLASS /dsn/2ui5_cl_xml_view_cc DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        view TYPE REF TO /dsn/2ui5_cl_xml_view.

  PROTECTED SECTION.
    DATA mo_view TYPE REF TO /dsn/2ui5_cl_xml_view.

  PRIVATE SECTION.
ENDCLASS.


CLASS /dsn/2ui5_cl_xml_view_cc IMPLEMENTATION.
  ...
  METHOD camera_picture.
    ...
    mo_view->_generic( name   = `CameraPicture`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `press`    v = press )
                                         ( n = `OnPhoto`    v = onphoto )
                                         ( n = `autoplay` v = /dsn/2ui5_cl_util=>boolean_abap_2_json( autoplay ) )
         ) ).
  ...
  METHOD file_uploader.
    ...
    mo_view->_generic(
        ...
        t_prop = VALUE #( (  n = `placeholder`        v = placeholder )
                          ...
                          (  n = `path`               v = path )
                          (  n = `value`              v = value )
                          (  n = `iconOnly`           v = /dsn/2ui5_cl_util=>boolean_abap_2_json( icononly ) )
                          (  n = `buttonOnly`         v = /dsn/2ui5_cl_util=>boolean_abap_2_json( buttononly ) )
                          (  n = `buttonText`         v = buttontext )
                          (  n = `uploadButtonText`   v = uploadbuttontext )
                          (  n = `fileType`           v = filetype )
                          (  n = `checkDirectUpload`  v = /dsn/2ui5_cl_util=>boolean_abap_2_json( checkdirectupload ) )
                          (  n = `icon`           v = icon )
  ...
  METHOD geolocation.
    ...
    mo_view->_generic( name   = `Geolocation`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `speed`  v = speed )
                           ( n = `heading`  v = heading )
                           ( n = `enableHighAccuracy`  v = /dsn/2ui5_cl_util=>boolean_abap_2_json( enablehighaccuracy ) )
                           ( n = `timeout`  v = timeout )
                ) ).
  ...
  METHOD timer.
    ...
    mo_view->_generic( name   = `Timer`
                       ...
                       t_prop = VALUE #( ( n = `delayMS`  v = delayms )
                                         ( n = `finished`  v = finished )
                                         ( n = `checkActive`  v = /dsn/2ui5_cl_util=>boolean_abap_2_json( checkactive ) )
                                         ( n = `checkRepeat`  v = /dsn/2ui5_cl_util=>boolean_abap_2_json( checkrepeat ) )
                ) ).
...
*                                ( n = `checkRepeat`  v = z2ui5_cl_util=>boolean_abap_2_json( checkrepeat ) )
  ...
  METHOD lp_title.
    ...
    mo_view->_generic( name   = `LPTitle`
                       ...
                       t_prop = VALUE #(
                        ( n = `title`  v = title )
                        ( n = `ApplicationFullWidth`  v = /dsn/2ui5_cl_util=>boolean_abap_2_json( applicationfullwidth ) ) ) ).
  ...
  METHOD dirty.
    ...
    mo_view->_generic( name   = `Dirty`
                       ns     = `z2ui5`
                       t_prop = VALUE #( ( n = `isDirty`  v = /dsn/2ui5_cl_util=>boolean_abap_2_json( isdirty ) ) ) ).

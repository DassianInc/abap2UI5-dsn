CLASS /dsn/2ui5_cl_core_srv_json DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS model_front_to_back
      IMPORTING
        view    TYPE string
        t_attri TYPE REF TO /dsn/2ui5_if_core_types=>ty_t_attri
        model   TYPE REF TO /dsn/2ui5_if_ajson.
...
CLASS /dsn/2ui5_cl_core_srv_json IMPLEMENTATION.
  METHOD model_front_to_back.

    IF line_exists( t_attri->*[ view = view ] ).
      DATA(lv_view) = view.
    ELSE.
      lv_view = /dsn/2ui5_if_client=>cs_view-main.
    ENDIF.

    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
         WHERE     bind_type = /dsn/2ui5_if_core_types=>cs_bind_type-two_way
               AND view      = lv_view.
      TRY.
        ...
        CATCH cx_root INTO DATA(x).
          /dsn/2ui5_cl_util=>x_raise( |JSON_PARSING_ERROR: { x->get_text( ) } | ).
      ENDTRY.
    ENDLOOP.
    ...
    TRY.
        ...
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.
          ...
          IF lr_attri->custom_mapper IS BOUND.
            DATA(ajson) = CAST /dsn/2ui5_if_ajson( /dsn/2ui5_cl_ajson=>create_empty(
                                                   ii_custom_mapping = lr_attri->custom_mapper ) ).
          ELSE.
            ajson = CAST /dsn/2ui5_if_ajson( /dsn/2ui5_cl_ajson=>create_empty(
                                             ii_custom_mapping = /dsn/2ui5_cl_ajson_mapping=>create_upper_case( ) ) ).
          ENDIF.

          CASE lr_attri->bind_type.
            WHEN /dsn/2ui5_if_core_types=>cs_bind_type-one_way
            OR /dsn/2ui5_if_core_types=>cs_bind_type-two_way.
...
*              ASSERT sy-subrc = 0.
            ...
            WHEN /dsn/2ui5_if_core_types=>cs_bind_type-one_time.
              ajson->set( iv_ignore_empty = abap_false
                          iv_path         = `/`
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result->set( iv_path = `/`
                           iv_val  = val-s_front ).
        ajson_result = ajson_result->filter( NEW /dsn/2ui5_cl_core_srv_json( ) ).

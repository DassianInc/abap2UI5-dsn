CLASS /dsn/2ui5_cl_core_handler DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE /dsn/2ui5_if_core_types=>ty_s_request.
    DATA ms_response     TYPE /dsn/2ui5_if_core_types=>ty_s_response.
  ...
  PROTECTED SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE /dsn/2ui5_if_core_types=>ty_s_request.

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE /dsn/2ui5_if_core_types=>ty_s_response
      RETURNING
...
CLASS /dsn/2ui5_cl_core_handler IMPLEMENTATION.


  METHOD request_json_to_abap.
    TRY.

        DATA(lo_ajson) = CAST /dsn/2ui5_if_ajson( /dsn/2ui5_cl_ajson=>parse( val ) ).
        lo_ajson = lo_ajson->slice( 'value' ).

        DATA(lv_model_edit_name) = |/{ /dsn/2ui5_if_core_types=>cs_ui5-two_way_model }|.

        result-o_model = /dsn/2ui5_cl_ajson=>create_empty( ).
        ...
        TRY.
            IF result-s_front-o_comp_data IS BOUND.
              ...
              result-s_control-app_start = /dsn/2ui5_cl_util=>c_trim_upper( result-s_control-app_start ).
            ENDIF.
          CATCH cx_root.
        ENDTRY.
        ...
        TRY.
            ...
            ENDIF.
            result-s_control-app_start_draft = /dsn/2ui5_cl_util=>c_trim_upper(
                                           /dsn/2ui5_cl_util=>url_param_get( val = `z2ui5-xapp-state`
                                                                         url = lv_hash ) ).
          CATCH cx_root.
        ENDTRY.
        ...
        result-s_control-app_start = /dsn/2ui5_cl_util=>c_trim_upper(
                                         /dsn/2ui5_cl_util=>url_param_get( val = `app_start`
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        DATA(ajson_result) = CAST /dsn/2ui5_if_ajson( /dsn/2ui5_cl_ajson=>create_empty(
                                                      ii_custom_mapping = /dsn/2ui5_cl_ajson_mapping=>create_upper_case( ) ) ).
  ...
  METHOD /dsn/2ui5_if_ajson_filter~keep_node.
    ...
    CASE iv_visit.
      ...
      WHEN /dsn/2ui5_if_ajson_filter=>visit_type-value.
      ...
      WHEN /dsn/2ui5_if_ajson_filter=>visit_type-close.
  ...
  METHOD constructor.
    ...
    mv_request_json = val.
    mo_action = NEW /dsn/2ui5_cl_core_action( me ).
  ...
  METHOD main_begin.
    TRY.
        ...
        ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
          NEW /dsn/2ui5_cl_core_srv_draft( )->cleanup( ).
  ...
  METHOD main_end.
    ...
    ms_response = VALUE #( s_front-params = mo_action->ms_next-s_set
                           ...
                           s_front-app    = /dsn/2ui5_cl_util=>rtti_get_classname_by_ref( mo_action->mo_app->mo_app ) ).
    ...
    IF CAST /dsn/2ui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW /dsn/2ui5_cl_core_client( mo_action ).
        DATA(li_app)    = CAST /dsn/2ui5_if_app( mo_action->mo_app->mo_app ).

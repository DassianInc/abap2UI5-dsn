...
CLASS /dsn/2ui5_cl_srt_refdescr DEFINITION
  PUBLIC
  INHERITING FROM /dsn/2ui5_cl_srt_datadescr
  CREATE PUBLIC.

  PUBLIC SECTION.

    DATA referenced_type TYPE REF TO /dsn/2ui5_cl_srt_typedescr.
...
CLASS /dsn/2ui5_cl_srt_refdescr IMPLEMENTATION.
  METHOD constructor.
    super->constructor( rtti ).
    CREATE OBJECT referenced_type TYPE /dsn/2ui5_cl_srt_typedescr
